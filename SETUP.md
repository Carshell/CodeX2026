...
3. CircleCI opens PR: `ci/dev-images-<sha>` updating dev overlay tags.
4. Merge that PR.
5. Argo auto-syncs `online-boutique-dev`.
6. Promote same tag to staging/prod by PR updates in those overlays, then manual sync in Argo UI.
